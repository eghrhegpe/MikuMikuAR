...
export const dom = {
    ...
    scenePanel: document.getElementById("scenePanel") as HTMLElement,
    sceneList: document.getElementById("sceneList") as HTMLElement,
    sceneCount: document.getElementById("sceneCount") as HTMLElement,
    btnSaveScene: document.getElementById("btnSaveScene") as HTMLButtonElement,
    btnLoadScene: document.getElementById("btnLoadScene") as HTMLButtonElement,
    ...
    vmdNotify: document.getElementById("vmdNotify") as HTMLElement,
