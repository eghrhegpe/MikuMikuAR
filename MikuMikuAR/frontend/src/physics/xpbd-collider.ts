...
export const DEFAULT_BODY_CAPSULES: CapsuleSpec[] = [
  ...
  { name: "waist",     boneName: "下半身",   radius: 0.13, halfHeight: 0.10 },
  { name: "hip",       boneName: "腰",       radius: 0.16, halfHeight: 0.08 },
  { name: "upperArmL", boneName: "左腕",     radius: 0.07, halfHeight: 0.10 },
  { name: "upperArmR", boneName: "右腕",     radius: 0.07, halfHeight: 0.10 },
  { name: "lowerArmL", boneName: "左ひじ",   radius: 0.06, halfHeight: 0.10 },
  { name: "lowerArmR", boneName: "右ひじ",   radius: 0.06, halfHeight: 0.10 },
...
export class SdfCollider {
  ...
  private _solveCapsule(solver: XpbdSolver, cap: SdfCapsule): void {
    ...
    for (let i = 0; i < solver.particles.length; i++) {
      ...
      if (dist >= minDist || dist < 1e-10) continue;
