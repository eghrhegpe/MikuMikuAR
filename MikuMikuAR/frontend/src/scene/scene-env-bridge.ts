...
import { applyEnvState as applyEnvStateFacade, applySky, updateWaterAnimSpeed, registerSceneTickCallback, ensureEnvUpdateObserver } from "./scene-env";
import {
    scene,
    setLightState, setRenderState,
    _updateSunDisc,
} from "./scene";
