...
> **背景**：灯光系统有七宗罪——CSM 是纸糊的、轨道角度会失忆、半球光独裁、时间流转遗忘、水面西西弗斯、级联缺席、降级缺失。
> **过程**：CascadedShadowGenerator 替换 + 轨道精度 0.05° + 半球光民主化 + stopTimeOfDay flush + 灯光菜单折叠 + 3D 指示器 + 黄昏平滑曲线 + Motion Blur/Sharpen/GlowLayer 接入。
