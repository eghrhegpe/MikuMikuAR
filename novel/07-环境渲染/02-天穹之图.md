...
> **背景**：GradientMaterial 在 BACKSIDE 球体上全黑，SkyMaterial 同样问题，自定义 ShaderMaterial 被 ShaderStore 双实例阻断。
> **过程**：三套方案失败后，改用 StandardMaterial + Canvas 2D 渐变贴图——六行代码，零延迟，删掉"gradient"模式。
