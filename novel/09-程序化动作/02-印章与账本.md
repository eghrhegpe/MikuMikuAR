...
> **背景**：视线追踪做好——头部转了，但眼睛不动，头发不动。写进 worldMatrix 没生效。
> **过程**：五层根因——worldMatrix 切片视图、WASM 双缓冲、骨骼层级绕过、四元数乘法顺序、FromLookDirectionRH 语义反转。切 JS 版 + 改印章（rotationQuaternion）修复，代价是失去物理。
