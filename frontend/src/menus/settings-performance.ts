    ...
    return {
        ...
        renderCustom: (container) => {
            ...
            cardContainer(container, (c) => {
                addToggleRow(
                    c,
                    t('settings.perf.defaultPhysics'),
            ...
            cardContainer(container, (c) => {
                addToggleRow(
                    c,
                    t('settings.perf.autoCenter'),
                    uiState.autoCenterModel !== false,
                    (v) => {
