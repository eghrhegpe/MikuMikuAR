...
export const zhCN: Record<string, string> = {
    ...
    'model-detail.overlay': '叠加动作',
    'model-detail.overlaySelect': '选择叠加动作',
    'model-detail.overlayWeight': '叠加权重',
    'model-detail.overlayClear': '清除叠加',
    'model-detail.overlayNone': '无',
    'model-detail.procOverlay': '程序化叠加',
    'model-detail.procOverlayApply': '叠加',
