...
export const zhCN: Record<string, string> = {
    ...
    'settings.font': '字体',
    // ===== 设置·字体/主题/名称优先级 i18n（ADR-157 审核补充） =====
    'settings.font.system': '系统默认',
    'settings.font.noto': '思源黑体',
    'settings.font.yahei': '微软雅黑',
    'settings.theme.classicBlue': '经典蓝',
    'settings.theme.sakuraPink': '樱花粉',
    'settings.theme.mintGreen': '薄荷绿',
    ...
    'settings.downloads': '下载文件夹',
    'settings.media': '媒体',
    'settings.system': '系统',
    'settings.diagnostic': 'AI 诊断',
    ...
    'model-detail.personalLightResetDefault': '重置默认',
    'model-detail.personalLightDefaultSaved': '✓ 已保存为个人灯光默认值',
    'model-detail.personalLightDefaultReset': '✓ 个人灯光默认值已重置',
    ...
    'motion.resetConfirm': '将清空所有已加载的场景动作，确定继续？',
    ...
    'motion.override.module.leftFoot': '左脚',
    'motion.override.module.rightFoot': '右脚',
    ...
    'section.fingerPose': '手指姿势',
    // ── 脚部旋转参数 ──
    'motion.foot.pitch': '足背屈',
    'motion.foot.yaw': '足内旋',
    'motion.foot.roll': '足侧翻',
    ...
    'scene.presetDesc.anime': '柔和调色 + 黑色描边 · 一键动漫观感',
    ...
    'library.extractingZipFailed': '✗ 解压 zip 失败',
    'library.importingZipFailed': '✗ 导入 zip 失败',
    ...
    'library.loadingModelFailed': '✗ 加载模型失败',
    'library.modelLoadFailed': '✗ 模型加载失败: ',
    'library.loadingMotion': '⏳ 加载动作...',
    'library.loadingMotionFailed': '✗ 加载动作失败',
    ...
    'env-preset.outdoorSunny': '户外晴天',
    'env-preset.concert': '演唱会',
    'env-preset.photoStudio': '摄影棚',
    'env-preset.duskSoft': '黄昏柔光',
    'env-preset.rainyDay': '雨天',
    'env-preset.sakuraSeason': '樱花季',
    'env-preset.cyberCity': '赛博都市',
    ...
    'main.networkOffline': '⚠️ 网络已断开，模型广场等在线功能不可用',
    'main.networkOnline': '✅ 网络已恢复',
    'main.sceneAutoSaved': '场景已自动保存',
    ...
    'env.groundInfiniteEnabled': '无限地面',
    ...
    'env.groundElevationColoringEnabled': '高程着色',
    'env.pbr': 'PBR 材质',
    ...
    'env.waterFogStart': '雾起始距离',
    'env.waterFogEnd': '雾终止距离',
    ...
    'env.reflectionModeProbe': '环境映射 (Probe)',
    'env.reflectionModeSsr': '屏幕反射 (SSR)',
    'env.reflectionModePlanar': '镜面反射 (Planar)',
    ...
    'settings.perf.frameCapHintBrowser':
        '是否控制 babymmd 的渲染帧率（浏览器/WebView 渲染自带垂直同步效果，无需设置垂直同步）',
    ...
    'settings.perf.shadow': '阴影 (Shadow)',
    'settings.perf.bloom': '泛光 (Bloom)',
    'settings.perf.fxaa': '抗锯齿 (FXAA)',
    'settings.perf.dof': '景深 (DOF)',
    'settings.perf.vignette': '暗角 (Vignette)',
    'settings.perf.outline': '边缘高亮 (Outline)',
    'settings.perf.glow': '辉光 (Glow)',
    'settings.perf.chromaticAberration': '色差 (Chromatic Aberration)',
    'settings.perf.grain': '颗粒 (Grain)',
    ...
    'settings.about.update.downloading': '下载中…',
    'settings.about.update.downloadFailed': '下载失败',
    'settings.about.update.installLaunched': '已启动安装',
    ...
    // ===== [doc:adr-195] 下载文件夹统一摄入 =====
    'downloads.stagingDir': '下载文件夹',
    'downloads.stagingSet': '已选择: {dir}',
    'downloads.stagingNotSet': '未选择下载文件夹',
    'downloads.androidStagingHint': 'Android：共享存储模式下读取 /sdcard/Download',
    'downloads.pickStagingDir': '选择下载文件夹',
    ...
    'downloads.manageImported': '导入记录',
    'downloads.clearImported': '清理已导入记录',
    'downloads.clearConfirm': '确定要清理所有已导入记录吗？这不会删除实际文件。',
    'downloads.androidNotReady': 'Android：需在共享存储模式下使用',
    'downloads.permissionNeeded': '需要读取下载文件夹权限',
    'downloads.supportedHint': '支持 PMX / VMD / 音频 / ZIP，将递归扫描子目录',
    'downloads.scanConfirm': '即将导入 {count} 个文件到模型库（不自动加载到场景），是否继续？',
    'downloads.canceled': '已取消',
    'downloads.androidNeedShared': 'Android 需开启共享存储模式才能读取下载文件夹',
    ...
    // ===== [doc:adr-196] AI 诊断助手 =====
    'ai.welcome': '你好！我是 AI 诊断助手，可以帮助你分析错误和场景状态。请描述你遇到的问题。',
    'ai.context.title': '上下文信息',
    'ai.context.header': '当前上下文：\n',
    'ai.context.errors': '已捕获的错误：\n',
    'ai.context.scene': '场景状态：\n',
    'ai.chat.title': '对话',
    'ai.chat.you': '你',
    'ai.chat.assistant': '助手',
    'ai.chat.placeholder': '描述问题或提问...',
    'ai.chat.send': '发送',
    'ai.chat.stop': '停止',
    'ai.chat.thinking': '思考中…',
    'ai.chat.reasoning': '思考过程',
    'ai.chat.tool': '工具',
    'ai.chat.toolCalls': '调用了 {count} 个工具',
    'ai.chat.toolResult': '工具结果',
    'ai.chat.untitled': '未命名会话',
    'ai.chat.newSession': '新建会话',
    'ai.chat.history': '历史会话',
    'ai.chat.rename': '重命名',
    'ai.chat.delete': '删除',
    'ai.chat.deleteConfirm': '确定删除会话「{title}」吗？',
    'ai.config.title': '配置',
    ...
    'ai.dialogue.emotion.happy': '开心',
    'ai.dialogue.emotion.sad': '伤心',
    ...
    'ai.system.control':
        '你是 MikuMikuAR 场景控制助手。使用工具修改场景。操作前先调用只读工具（如 scene:list-models、library:list）了解当前状态，再执行操作。标注 [只读，自动执行] 的工具可安全调用，无需用户确认。',
    'ai.system.controlFormat':
        '直接调用工具完成操作。如果用户要求不支持的操作，简要说明你能做什么。',
    'ai.system.catalogHeader': '可用工具（仅以下操作支持）：',
    'ai.actions.control.setLightIntensity': '设置灯光强度',
    'ai.actions.control.setLightColor': '设置灯光颜色',
    'ai.actions.control.setCameraMode': '切换相机模式',
    'ai.actions.control.setEnvPreset': '切换环境预设',
    'ai.actions.control.toggleGround': '切换地面可见性',
    'ai.actions.control.loadModel': '加载模型',
    'ai.actions.control.loadMotion': '替换动作',
    'ai.actions.control.setPerformance': '切换性能模式',
    'ai.actions.motion.lipsync.toggle': '切换口型同步',
    'ai.actions.motion.clearAll': '清除全部动作',
    'ai.actions.motion.retarget.mixamo': '导入 Mixamo 动画',
    'ai.actions.motion.retarget.vrm': '导入 VRM 动画',
    'ai.actions.motion.retarget.custom': '导入自定义动画',
    'ai.actions.motion.model.pause': '暂停/继续播放',
    'ai.actions.motion.model.reset': '重置动画',
    'ai.actions.motion.model.pose': '打开展示库',
    'ai.actions.motion.model.loop': '切换循环播放',
    'ai.actions.motion.procmotion.setMode': '设置程序化动作模式',
    'ai.actions.motion.loadCameraVmd': '加载相机 VMD',
    'ai.actions.motion.addSceneVmd': '添加场景 VMD',
    ...
    'ai.actions.settings.resourceRoot': '选择资源根目录',
    ...
    'ai.actions.settings.path.setting': '选择设置覆盖路径',
    'ai.actions.settings.setLang': '切换语言',
    'ai.actions.scene.screenshotCurrent': '截图当前模型',
    'ai.actions.scene.screenshotBatch': '批量截图',
    'ai.actions.scene.save': '保存场景预设',
    'ai.actions.scene.undo': '撤销操作',
    'ai.actions.scene.listModels': '列出场景内模型',
    'ai.actions.env.bindParticleTexture': '绑定粒子纹理',
    'ai.actions.env.bindSkyTexture': '绑定天空纹理',
    'ai.actions.env.bindStarsTexture': '绑定星空纹理',
    'ai.actions.library.rescan': '重新扫描模型库',
    'ai.actions.library.importFile': '导入模型文件',
    'ai.actions.library.setFormation': '设置队形',
    'ai.actions.library.list': '列出可用模型',
    'ai.actions.diagnostic.getErrors': '获取前端错误日志',
    'ai.actions.diagnostic.getSceneSnapshot': '获取场景运行快照',
    'ai.actions.diagnostic.getFrontendState': '获取前端状态摘要',
    'ai.actions.diagnostic.getBackendLogs': '获取后端日志',
    'ai.actions.diagnostic.getBackendState': '获取后端状态',
    'ai.control.pending': '⏳ 待执行操作 — 请审阅后应用',
    'ai.control.pendingProgress': '⏳ 待执行操作 ({current}/{total}) — 请审阅后应用',
    'ai.control.apply': '应用',
    ...
    'ai.status.network': '网络连接失败',
    'ai.status.unauthorized': '认证失败',
    'ai.status.notFound': '端点或模型不存在',
    'ai.status.rateLimit': '请求频率超限',
    'ai.status.server': '服务端错误',
    'ai.status.unknown': '未知错误',
