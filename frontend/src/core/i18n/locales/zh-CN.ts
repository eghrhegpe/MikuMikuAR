...
export const zhCN: Record<string, string> = {
    ...
    'motion.procPresets': '参数预设',
    'motion.procPresetSave': '保存当前参数为预设',
    'motion.procPresetName': '自定义预设',
    'motion.procPresetEmpty': '暂无自定义预设',
    'motion.procPresetTooMany': '自定义预设已达上限（10）',
    'procPreset.idle.gentleBreath': '轻柔呼吸',
    'procPreset.idle.standard': '标准待机',
    'procPreset.idle.tense': '紧张僵立',
    'procPreset.idle.relaxed': '松弛晃动',
    'procPreset.autodance.standardGroove': '标准律动',
    'procPreset.autodance.energetic': '劲爆舞曲',
    'procPreset.autodance.lightBeat': '轻快节拍',
    'procPreset.autodance.robotic': '机械卡点',
    'motion.speed': '速度',
    ...
    'scene.presetDesc.cartoon': 'Neutral 色调映射 · 高饱和高对比 · 黑色线框',
    'scene.presetDesc.realistic': 'ACES 色调映射 · 浅景深 · 电影暗角',
    'scene.presetDesc.warm': 'ACES 色调映射 · 暖色背景 · 胶片感',
    ...
    'plaza.modeAuto': '自动',
    'plaza.modeEmbed': '内嵌页',
    'plaza.modeWindow': '独立窗口',
    'plaza.modeExternal': '系统浏览器',
    'plaza.openSite': '打开网站',
    'toast.undo': '撤销',
    ...
    'settings.about.update.available': '发现新版本 {latest}（当前 {current}）',
    'settings.about.update.latest': '已是最新版本（{current}）',
    ...
    'settings.about.maintenance.clearExtractConfirm': '确定清理解压缓存？下次加载模型时将自动重新生成。',
    'settings.about.maintenance.clearThumbnail': '清除缩略图缓存',
    'settings.about.maintenance.clearThumbnailConfirm': '确定清除缩略图缓存？',
    ...
    'goerr.llm.endpointEmpty': 'LLM 端点为空',
    'goerr.llm.noModels': '响应无有效模型列表',
    'goerr.llm.unexpectedFormat': '响应不是 OpenAI 或 Ollama 格式',
