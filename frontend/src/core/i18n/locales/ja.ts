...
export const ja: Record<string, string> = {
    ...
    'model-detail.overlay': 'オーバーレイ',
    'model-detail.overlaySelect': 'オーバーレイを選択',
    'model-detail.overlayWeight': 'オーバーレイ重み',
    'model-detail.overlayClear': 'オーバーレイ解除',
    'model-detail.overlayNone': 'なし',
    'model-detail.procOverlay': 'プロシージャルオーバーレイ',
    'model-detail.procOverlayApply': 'オーバーレイ',
