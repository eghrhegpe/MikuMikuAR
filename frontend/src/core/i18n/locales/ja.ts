...
export const ja: Record<string, string> = {
    ...
    'motion.layerTo': 'レイヤー→ {name}',
    'motion.addLayer': 'レイヤー追加',
    'motion.addLayerTo': 'レイヤー追加→ {name}',
    'motion.addGaze': '視線追跡を追加',
    'motion.noLayers': 'レイヤーなし — 2つ目のVMDを追加するとブレンドが有効になります',
    'motion.deleteLayer': 'レイヤー削除',
    'motion.clearAllLayers': '🗑 全レイヤークリア',
    'motion.actor': 'キャラクター',
    'motion.model': 'モデル',
    'motion.modelLayers': '{name} レイヤー',
    'motion.layerCount': '{n} レイヤー',
    'motion.camera': 'カメラ',
