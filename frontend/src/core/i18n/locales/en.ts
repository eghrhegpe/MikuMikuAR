...
export const en: Record<string, string> = {
    ...
    'settings.font': 'Font',
    // ===== Settings: Font/Theme/Name Priority i18n (ADR-157) =====
    'settings.font.system': 'System Default',
    'settings.font.noto': 'Noto Sans',
    'settings.font.yahei': 'Microsoft YaHei',
    'settings.theme.classicBlue': 'Classic Blue',
    'settings.theme.sakuraPink': 'Sakura Pink',
    'settings.theme.mintGreen': 'Mint Green',
    ...
    'settings.diagnostic': 'AI Diagnostic',
    ...
    'settings.graphics.physicsHud': 'Physics & Display',
    'settings.effects.lighting': 'Lighting',
    'settings.effects.antialiasing': 'Anti-aliasing',
    'settings.effects.postprocess': 'Post-processing',
    ...
    'model-detail.personalLightResetDefault': 'Reset Default',
    'model-detail.personalLightDefaultSaved': '✓ Personal light set as default',
    'model-detail.personalLightDefaultReset': '✓ Personal light default reset',
    'model-detail.attachment': 'Attachment',
    'model-detail.attachmentAttached': 'Attached to {parent} at {bone}',
    'model-detail.attachmentDetach': 'Detach',
    'model-detail.attachmentAttach': 'Attach to Model…',
    'model-detail.attachmentSelectParent': 'Select Parent Model',
    'model-detail.attachmentSelectBone': 'Select Bone',
    'model-detail.attachmentNoParent': 'No available parent models',
    'model-detail.attachmentNoBone': 'No available bones',
    ...
    'motion.resetConfirm': 'This will clear all loaded scene motions. Continue?',
    ...
    'motion.procPresets': 'Presets',
    'motion.procPresetSave': 'Save Current Params as Preset',
    'motion.procPresetName': 'Custom Preset',
    'motion.procPresetEmpty': 'No custom presets yet',
    'motion.procPresetTooMany': 'Custom preset limit reached (10)',
    'procPreset.idle.gentleBreath': 'Gentle Breath',
    'procPreset.idle.standard': 'Standard Idle',
    'procPreset.idle.tense': 'Tense',
    'procPreset.idle.relaxed': 'Relaxed Sway',
    'procPreset.autodance.standardGroove': 'Standard Groove',
    'procPreset.autodance.energetic': 'Energetic',
    'procPreset.autodance.lightBeat': 'Light Beat',
    'procPreset.autodance.robotic': 'Robotic',
    'motion.speed': 'Speed',
    ...
    'motion.override.module.leftHand': 'Left Hand',
    'motion.override.module.rightHand': 'Right Hand',
    'motion.override.module.ridingModel': 'Riding Model',
    'motion.override.module.leftFoot': 'Left Foot',
    'motion.override.module.rightFoot': 'Right Foot',
    ...
    'section.bodyPosition': 'Body Position Offset',
    'param.bodyHeight': 'Body Height',
    'param.bodyDepth': 'Body Forward/Back',
    'param.pitch': 'Wrist Bend',
    'param.yaw': 'Wrist Swing',
    'param.roll': 'Wrist Twist',
    'section.handPosition': 'Arm Position Offset',
    'param.handPosX': 'Wrist X Offset',
    'param.handPosY': 'Wrist Y Offset',
    'param.handPosZ': 'Wrist Z Offset',
    'section.fingerPose': 'Finger Pose',
    'motion.foot.pitch': 'Foot Dorsiflex',
    'motion.foot.yaw': 'Foot Inward',
    'motion.foot.roll': 'Foot Eversion',
    'section.footPosition': 'Foot Position Offset',
    'param.footPosX': 'Foot X Offset',
    'param.footPosY': 'Foot Y Offset',
    'param.footPosZ': 'Foot Z Offset',
    ...
    'motion.clipboardUnavailable': 'Clipboard unavailable',
    ...
    'scene.accessory.attached': '✓ Attached {name} to {bone}',
    ...
    'scene.dofFocus': 'Focus Distance',
    'scene.dofFocal': 'Focal Length',
    'scene.vignette': 'Vignette',
    'scene.chromatic': 'Chromatic Aberration',
    'scene.grain': 'Grain',
    'scene.sharpen': 'Sharpen',
    'scene.glow': 'Glow',
    'scene.opticalEffects': 'Visual Effects',
    ...
    'library.extractingZipFailed': '✗ Extracting zip failed',
    'library.importingZipFailed': '✗ Importing zip failed',
    ...
    'library.loadingModelFailed': '✗ Loading model failed',
    'library.modelLoadFailed': '✗ Model load failed: ',
    'library.loadingMotion': '⏳ Loading motion...',
    'library.loadingMotionFailed': '✗ Loading motion failed',
    ...
    'scene.ar.webxrCopyReport': 'Copy Report',
    'scene.ar.webxrCopied': '✓ Probe report copied to clipboard',
    ...
    'env-preset.outdoorSunny': 'Outdoor Sunny',
    'env-preset.concert': 'Concert',
    'env-preset.photoStudio': 'Photo Studio',
    'env-preset.duskSoft': 'Dusk Soft Light',
    'env-preset.rainyDay': 'Rainy Day',
    'env-preset.sakuraSeason': 'Sakura Season',
    'env-preset.cyberCity': 'Cyber City',
    ...
    'settings.readFile': '✗ Failed to read file',
    ...
    'main.networkOffline': '⚠️ Network offline. Online features (plaza, etc.) are unavailable',
    'main.networkOnline': '✅ Network restored',
    'main.sceneAutoSaved': 'Scene auto-saved',
    ...
    'env.brightness': 'Sky Brightness',
    'env.environmentBrightness': 'Global Brightness',
    'env.skyRotationSpeed': 'Sky rotation speed',
    'env.lightControl': 'Light control',
    'env.sunIntensity': 'Sun intensity',
    'env.skyLighting': 'Env reflection',
    'env.ground': 'Ground',
    ...
    'env.foam': 'Foam',
    'env.foamEnabled': 'Enable foam',
    'env.foamColor': 'Foam color',
    ...
    'env.groundInfiniteEnabled': 'Infinite Ground',
    ...
    'env.groundElevationColoringEnabled': 'Elevation Coloring',
    ...
    'env.foamNoise': 'Foam noise disturbance',
    ...
    'env.reflectionQualityHigh': 'High (2048)',
    'env.reflectionQualityMedium': 'Medium (1024)',
    'env.reflectionQualityLow': 'Low (512)',
    'env.reflectionQualityOff': 'Off',
    'env.reflectionMode': 'Reflection Mode',
    'env.reflectionModeNone': 'Off',
    'env.reflectionModeProbe': 'Environment (Probe)',
    'env.reflectionModeSsr': 'Screen Space (SSR)',
    'env.reflectionModePlanar': 'Mirror (Planar)',
    'env.reflectionModeHybrid': 'Hybrid',
    ...
    'env.groundPresetCleanGray': 'Clean Gray',
    'env.groundPresetMirrorStage': 'Mirror Stage',
    'env.groundPresetGrass': 'Grass',
    ...
    'env.cloudVisibility': 'Visibility',
    ...
    'plaza.openMode': 'Open Mode',
    'plaza.modeAuto': 'Auto',
    'plaza.modeEmbed': 'Embedded',
    'plaza.modeWindow': 'Window',
    'plaza.modeExternal': 'System Browser',
    'plaza.openSite': 'Open Site',
    'toast.undo': 'Undo',
    ...
    'settings.about.communityTools': 'Community Tools',
    'about.nanoemCn': 'nanoem-cn (Chinese Edition)',
    ...
    'settings.about.update.downloadFailed': 'Download failed',
    'settings.about.update.installLaunched': 'Install launched',
    'settings.about.maintenance': 'Maintenance',
    'settings.about.maintenance.clearExtract': 'Clear extract cache',
    'settings.about.maintenance.clearExtractConfirm': 'Clear extract cache? It will be regenerated on next model load.',
    'settings.about.maintenance.clearThumbnail': 'Clear thumbnail cache',
    'settings.about.maintenance.clearThumbnailConfirm': 'Clear thumbnail cache?',
    ...
    // ===== [doc:adr-195] Download folder unified ingestion =====
    'downloads.stagingDir': 'Download Folder',
    'downloads.stagingSet': 'Selected: {dir}',
    'downloads.stagingNotSet': 'No download folder selected',
    'downloads.androidStagingHint': 'Android: reads /sdcard/Download in shared storage mode',
    'downloads.pickStagingDir': 'Choose Download Folder',
    ...
    'downloads.manageImported': 'Import Records',
    ...
    'downloads.androidNotReady': 'Android: requires shared storage mode',
    'downloads.permissionNeeded': 'Permission to read the download folder is required',
    'downloads.supportedHint': 'Supports PMX / VMD / audio / ZIP; scans subfolders recursively',
    'downloads.scanConfirm':
        'About to import {count} files into the model library (not auto-loaded to scene). Continue?',
    'downloads.canceled': 'Canceled',
    'downloads.androidNeedShared': 'Android needs shared storage mode to read the download folder',
    ...
    'ai.welcome':
        'Hello! I am the AI Diagnostic Assistant. I can help you analyze errors and scene status. Describe the issue you are experiencing.',
    'ai.context.title': 'Context Information',
    'ai.context.header': 'Current context:\n',
    'ai.context.errors': 'Captured errors:\n',
    'ai.context.scene': 'Scene status:\n',
    'ai.chat.title': 'Chat',
    'ai.chat.you': 'You',
    'ai.chat.assistant': 'Assistant',
    'ai.chat.placeholder': 'Describe the issue or ask a question...',
    'ai.chat.send': 'Send',
    'ai.chat.stop': 'Stop',
    ...
    'ai.chat.deleteConfirm': 'Delete chat "{title}"?',
    ...
    'ai.system.format':
        "Respond in the user's language. Start with a conclusion, then provide actionable suggestions. Mark confidence as high/medium/low.",
    'ai.system.safety':
        'You are in read-only diagnostic mode. You cannot modify the scene or files. Only provide analysis and advice.',
    'ai.system.chat':
        'You are a MikuMikuAR AI assistant. Chat freely with the user. Keep responses concise and helpful.',
    'ai.mode.title': 'Mode',
    ...
    'ai.actions.motion.lipsync.toggle': 'Toggle lip sync',
    'ai.actions.motion.clearAll': 'Clear all motions',
    'ai.actions.motion.retarget.mixamo': 'Import Mixamo animation',
    'ai.actions.motion.retarget.vrm': 'Import VRM animation',
    'ai.actions.motion.retarget.custom': 'Import custom animation',
    'ai.actions.motion.model.pause': 'Pause/resume playback',
    'ai.actions.motion.model.reset': 'Reset animation',
    'ai.actions.motion.model.pose': 'Open pose library',
    'ai.actions.motion.model.loop': 'Toggle loop playback',
    'ai.actions.motion.procmotion.setMode': 'Set procedural motion mode',
    'ai.actions.motion.loadCameraVmd': 'Load camera VMD',
    'ai.actions.motion.addSceneVmd': 'Add scene VMD',
    ...
    'ai.actions.settings.resourceRoot': 'Select resource root',
    ...
    'ai.actions.settings.path.setting': 'Select setting override path',
    'ai.actions.settings.setLang': 'Switch language',
    'ai.actions.scene.screenshotCurrent': 'Screenshot current model',
    ...
    'ai.actions.diagnostic.getBackendLogs': 'Get backend logs',
    'ai.actions.diagnostic.getBackendState': 'Get backend state',
    ...
    'ai.status.network': 'Network error',
    'ai.status.unauthorized': 'Auth failed',
    'ai.status.notFound': 'Endpoint/model not found',
    'ai.status.rateLimit': 'Rate limit exceeded',
    'ai.status.server': 'Server error',
    'ai.status.unknown': 'Unknown error',
