...
export const en: Record<string, string> = {
    ...
    'motion-preset.saveCurrent': 'Save current as preset',
    'motion-preset.defaultName': 'New Preset',
    'motion-preset.limitReached': '✗ Preset limit (10) reached. Delete old presets first.',
