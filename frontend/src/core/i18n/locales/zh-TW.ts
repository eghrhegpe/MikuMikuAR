...
export const zhTW: Record<string, string> = {
    ...
    'model-detail.overlay': '疊加動作',
    'model-detail.overlaySelect': '選擇疊加動作',
    'model-detail.overlayWeight': '疊加強度',
    'model-detail.overlayClear': '清除疊加',
    'model-detail.overlayNone': '無',
    'model-detail.procOverlay': '程式化疊加',
    'model-detail.procOverlayApply': '疊加',
