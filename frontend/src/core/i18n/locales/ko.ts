...
export const ko: Record<string, string> = {
    ...
    'settings.media': '미디어',
    'settings.downloads': '다운로드 폴더',
    'settings.system': '시스템',
    'settings.diagnostic': 'AI 진단',
    ...
    'model-detail.personalLightResetDefault': '기본값 재설정',
    'model-detail.personalLightDefaultSaved': '✓ 개인 조명이 기본값으로 설정되었습니다',
    'model-detail.personalLightDefaultReset': '✓ 개인 조명 기본값이 재설정되었습니다',
    'model-detail.attachment': '어태치먼트',
    'model-detail.attachmentAttached': '{parent}의 {bone}에 연결됨',
    'model-detail.attachmentDetach': '연결 해제',
    'model-detail.attachmentAttach': '모델에 연결…',
    'model-detail.attachmentSelectParent': '부모 모델 선택',
    'model-detail.attachmentSelectBone': '본 선택',
    'model-detail.attachmentNoParent': '사용 가능한 부모 모델이 없습니다',
    'model-detail.attachmentNoBone': '사용 가능한 본이 없습니다',
    ...
    'motion.intensity': '강도',
    'motion.procPresets': '프리셋',
    'motion.procPresetSave': '현재 파라미터를 프리셋으로 저장',
    'motion.procPresetName': '사용자 프리셋',
    'motion.procPresetEmpty': '사용자 프리셋이 없습니다',
    'motion.procPresetTooMany': '사용자 프리셋 상한(10) 도달',
    'procPreset.idle.gentleBreath': '부드러운 호흡',
    'procPreset.idle.standard': '기본 대기',
    'procPreset.idle.tense': '긴장 자세',
    'procPreset.idle.relaxed': '여유 스웨이',
    'procPreset.autodance.standardGroove': '기본 그루브',
    'procPreset.autodance.energetic': '에너지 댄스',
    'procPreset.autodance.lightBeat': '라이트 비트',
    'procPreset.autodance.robotic': '로보틱',
    'motion.speed': '속도',
    ...
    'motion.conflictHint': '⚠ {module}와 충돌',
    ...
    'motion.boneConflict.line':
        '{bone} 현재 적용: 「{winner}(우선순위{winnerPrio})」, 「{loser}(우선순위{loserPrio})」 밀림',
    ...
    'scene.debug': '디버그',
    'scene.collision': '충돌',
    'scene.accessory.attached': '✓ {name}을(를) {bone}에 연결했습니다',
    ...
    'scene.presetDesc.cartoon': 'Neutral 톤 매핑 · 고채도/고대비 · 검은 윤곽선',
    'scene.presetDesc.realistic': 'ACES 톤 매핑 · 얕은 피사계 심도 · 시네마틱 비네트',
    'scene.presetDesc.warm': 'ACES 톤 매핑 · 따뜻한 배경 · 필름 느낌',
    ...
    'library.extractingZipFailed': '✗ zip 압축 풀기 실패',
    'library.importingZipFailed': '✗ zip 가져오기 실패',
    ...
    'library.loadingModelFailed': '✗ 모델 로드 실패',
    'library.modelLoadFailed': '✗ 모델 로드 실패: ',
    'library.loadingMotion': '⏳ 모션 로드 중...',
    'library.loadingMotionFailed': '✗ 모션 로드 실패',
    ...
    'env.groundInfiniteEnabled': '무한 지면',
    'env.groundPitch': '피치',
    'env.groundRoll': '롤',
    ...
    'env.groundElevationColoringEnabled': '고도 착색',
    'env.pbr': 'PBR 머티리얼',
    ...
    'env.foamNoise': '거품 노이즈 교란',
    'env.waterFogColor': '수면 안개 색상',
    'env.waterFogStart': '안개 시작 거리',
    'env.waterFogEnd': '안개 종료 거리',
    ...
    'settings.about.communityTools': '커뮤니티 도구',
    'about.nanoemCn': 'nanoem 중국어판 (nanoem-cn)',
    ...
    'settings.about.update.downloading': '다운로드 중…',
    'settings.about.update.downloadFailed': '다운로드 실패',
    'settings.about.update.installLaunched': '설치 시작됨',
    'settings.about.maintenance': '유지보수 도구',
    'settings.about.maintenance.clearExtract': '추출 캐시 지우기',
    'settings.about.maintenance.clearExtractConfirm': '추출 캐시를 지우시겠습니까? 다음 모델 로드 시 자동으로 다시 생성됩니다.',
    'settings.about.maintenance.clearThumbnail': '썸네일 캐시 지우기',
    'settings.about.maintenance.clearThumbnailConfirm': '썸네일 캐시를 지우시겠습니까?',
    ...
    // ===== [doc:adr-195] 다운로드 폴더 통합 수집 =====
    'downloads.stagingDir': '다운로드 폴더',
    'downloads.stagingSet': '선택됨: {dir}',
    'downloads.stagingNotSet': '다운로드 폴더가 선택되지 않음',
    'downloads.androidStagingHint': 'Android: 공유 저장소 모드에서 /sdcard/Download 읽기',
    'downloads.pickStagingDir': '다운로드 폴더 선택',
    'downloads.scanImport': '스캔 및 가져오기',
    'downloads.scanAndImport': '스캔 및 가져오기',
    'downloads.running': '실행 중...',
    'downloads.scanning': '스캔 중...',
    'downloads.importingN': '{count}개 파일 가져오는 중...',
    'downloads.importingProgress': '가져옴 {ok}/{total}, 실패 {fail}',
    'downloads.done': '완료: {ok} 성공, {fail} 실패',
    'downloads.noNewFiles': '새 파일이 없습니다',
    'downloads.manageImported': '가져오기 기록',
    'downloads.clearImported': '가져오기 기록 지우기',
    'downloads.clearConfirm': '모든 가져오기 기록을 지우시겠습니까? 실제 파일은 삭제되지 않습니다.',
    ...
    'motion.override.module.leftHand': '왼손',
    'motion.override.module.rightHand': '오른손',
    'motion.override.module.ridingModel': '라이딩 모델',
    'motion.override.module.leftFoot': '왼발',
    'motion.override.module.rightFoot': '오른발',
    'motion.override.tunedParams': '{n}개 조정됨',
    'motion.override.activeBoneOverrides': '재정의 {n}개',
    'param.tilt': '기울임(상체)',
    'param.bend': '허리 굽힘',
    'param.twist': '허리 비틀기',
    'section.bodyPosition': '몸 위치 오프셋',
    'param.bodyHeight': '몸 높이',
    'param.bodyDepth': '몸 전후',
    'param.pitch': '손목 굽힘',
    'param.yaw': '손목 흔듦',
    'param.roll': '손목 돌림',
    'section.handPosition': '팔 위치 오프셋',
    'param.handPosX': '손목 X 오프셋',
    'param.handPosY': '손목 Y 오프셋',
    'param.handPosZ': '손목 Z 오프셋',
    'section.fingerPose': '핑거 포즈',
    'motion.foot.pitch': '발 배굴',
    'motion.foot.yaw': '발 내회전',
    'motion.foot.roll': '발 외번',
    'section.footPosition': '발 위치 오프셋',
    'param.footPosX': '발 X 오프셋',
    'param.footPosY': '발 Y 오프셋',
    'param.footPosZ': '발 Z 오프셋',
    'motion.preset': '프리셋',
    ...
    'plaza.openMode': '열기 모드',
    'plaza.modeAuto': '자동',
    'plaza.modeEmbed': '임베드',
    'plaza.modeWindow': '창',
    'plaza.modeExternal': '시스템 브라우저',
    'plaza.openSite': '사이트 열기',
    ...
    'ai.context.title': '컨텍스트 정보',
    'ai.context.header': '현재 컨텍스트:\n',
    'ai.context.errors': '캡처된 오류:\n',
    'ai.context.scene': '씬 상태:\n',
    'ai.chat.title': '채팅',
    'ai.chat.you': '나',
    'ai.chat.assistant': '어시스턴트',
    ...
    'ai.chat.tool': '도구',
    'ai.chat.toolCalls': '{count}개 도구 호출',
    'ai.chat.toolResult': '도구 결과',
    'ai.chat.untitled': '제목 없는 대화',
    'ai.chat.newSession': '새 대화',
    'ai.chat.history': '대화 기록',
    'ai.chat.rename': '이름 변경',
    'ai.chat.delete': '삭제',
    'ai.chat.deleteConfirm': '"{title}" 대화를 삭제하시겠습니까?',
    'ai.config.title': '설정',
    ...
    'ai.config.saved': '✓ 저장됨',
    'ai.config.saveFailed': '저장 실패',
    'ai.config.test': '연결 테스트',
    'ai.config.testing': '테스트 중...',
    'ai.config.connected': '✓ 연결됨',
    ...
    'ai.system.format':
        '사용자 언어로 응답하세요. 결론부터 말하고 실행 가능한 제안을 제공하세요. 신뢰도를 높음/중간/낮음으로 표시하세요.',
    'ai.system.safety':
        '읽기 전용 진단 모드입니다. 씬이나 파일을 수정할 수 없습니다. 분석 및 조언만 제공합니다.',
    'ai.system.chat':
        '당신은 MikuMikuAR AI 어시스턴트입니다. 사용자와 자유롭게 대화하세요. 한국어로 간결하게 응답하세요.',
    'ai.mode.title': '모드',
    ...
    'ai.actions.motion.lipsync.toggle': '립싱크 전환',
    'ai.actions.motion.clearAll': '모든 모션 지우기',
    'ai.actions.motion.retarget.mixamo': 'Mixamo 애니메이션 가져오기',
    'ai.actions.motion.retarget.vrm': 'VRM 애니메이션 가져오기',
    'ai.actions.motion.retarget.custom': '사용자 지정 애니메이션 가져오기',
    'ai.actions.motion.model.pause': '재생 일시정지/재개',
    'ai.actions.motion.model.reset': '애니메이션 재설정',
    'ai.actions.motion.model.pose': '포즈 라이브러리 열기',
    'ai.actions.motion.model.loop': '반복 재생 전환',
    'ai.actions.motion.procmotion.setMode': '프로시저럴 모션 모드 설정',
    'ai.actions.motion.loadCameraVmd': '카메라 VMD 불러오기',
    'ai.actions.motion.addSceneVmd': '씬 VMD 추가',
    ...
    'ai.actions.settings.resourceRoot': '리소스 루트 선택',
    ...
    'ai.actions.settings.path.setting': '설정 덮어쓰기 경로 선택',
    'ai.actions.settings.setLang': '언어 전환',
    'ai.actions.scene.screenshotCurrent': '현재 모델 스크린샷',
    ...
    'ai.actions.library.rescan': '모델 라이브러리 재스캔',
    'ai.actions.library.importFile': '모델 파일 가져오기',
    'ai.actions.library.setFormation': '대형 설정',
    'ai.actions.library.list': '사용 가능한 모델 목록',
    'ai.actions.diagnostic.getErrors': '프론트엔드 오류 로그 가져오기',
    'ai.actions.diagnostic.getSceneSnapshot': '씬 런타임 스냅샷 가져오기',
    'ai.actions.diagnostic.getFrontendState': '프론트엔드 상태 요약 가져오기',
    'ai.actions.diagnostic.getBackendLogs': '백엔드 로그 가져오기',
    'ai.actions.diagnostic.getBackendState': '백엔드 상태 가져오기',
    ...
    // 서비스 제공자 사전 설정 및 상태 피드백
    'ai.provider.ollama': 'Ollama',
    'ai.provider.deepseek': 'DeepSeek',
    'ai.provider.openai': 'OpenAI',
    'ai.provider.openrouter': 'OpenRouter',
    'ai.provider.custom': '사용자 정의',
    'ai.config.providerHint': '서비스 제공자를 선택하고 API 키를 입력하세요',
    'ai.config.doc': '{provider} 공식 사이트 →',
    'ai.validation.missingEndpoint': 'API 엔드포인트 누락',
    'ai.validation.missingKey': 'API 키 누락',
    'ai.validation.missingModel': '모델 이름 누락',
    'ai.validation.ok': '구성 완료',
    'ai.errors.resolveFailed': 'AI 서비스 초기화에 실패했습니다. 자세한 내용은 콘솔을 확인하세요.',
    'ai.config.notResolved': 'AI 서비스가 아직 준비되지 않았습니다. 잠시 기다려주세요...',
    'ai.errorAdvice.missingEndpoint': '서비스 제공자를 선택하거나 API 엔드포인트를 입력하세요.',
    'ai.errorAdvice.missingKey': '이 서비스 제공자에는 API 키가 필요합니다. 입력하세요.',
    'ai.errorAdvice.missingModel': '대화를 시작하려면 모델 이름을 입력해야 합니다.',
    'ai.errorAdvice.cors':
        '로컬 Ollama는 OLLAMA_ORIGINS=*를 설정하고 다시 시작하세요. 원격 API는 동일 출처 프록시 설정을 권장합니다.',
    'ai.errorAdvice.unauthorized': 'API 키가 유효하지 않거나 만료되었습니다. 확인하세요.',
    ...
    'ai.status.missingKey': 'API 키 필요',
    'ai.status.missingModel': '모델 미설정',
    'ai.status.cors': 'CORS 위험',
    'ai.status.connected': '연결됨',
    'ai.status.disconnected': '미연결',
    'ai.status.testing': '테스트 중',
    'ai.status.initializing': 'AI 백엔드에 연결 중...',
    'ai.status.error': '연결 실패',
    'ai.status.network': '네트워크 오류',
    'ai.status.unauthorized': '인증 실패',
    'ai.status.notFound': '엔드포인트/모델 없음',
    'ai.status.rateLimit': '요청 제한 초과',
    'ai.status.server': '서버 오류',
    'ai.status.unknown': '알 수 없는 오류',
};
