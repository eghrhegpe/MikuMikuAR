...
export const ko: Record<string, string> = {
    ...
    'model-detail.overlay': '오버레이',
    'model-detail.overlaySelect': '오버레이 선택',
    'model-detail.overlayWeight': '오버레이 가중치',
    'model-detail.overlayClear': '오버레이 해제',
    'model-detail.overlayNone': '없음',
    'model-detail.procOverlay': '절차적 오버레이',
    'model-detail.procOverlayApply': '오버레이',
