...
function buildDefaultEnvState(): EnvState {
    ...
    return {
        ...
        groundVisibleEnabled: s.groundVisibleEnabled.default,
        ...
        groundEmissiveColor: s.groundEmissiveColor.default.slice() as [number, number, number],
        groundEmissiveStrength: s.groundEmissiveStrength.default,
        groundEmissiveReflectMix: s.groundEmissiveReflectMix.default,
        groundEmissiveTexture: s.groundEmissiveTexture.default,
        ...
        waterFlipEnabled: s.waterFlipEnabled.default,
        ...
        bigWaveEnabled: s.bigWaveEnabled.default,
        ...
        waterDispersionEnabled: s.waterDispersionEnabled.default,
        ...
        causticEnabled: s.causticEnabled.default,
        ...
        foamEnabled: s.foamEnabled.default,
        foamThreshold: s.foamThreshold.default,
        foamIntensity: s.foamIntensity.default,
        foamOpacity: s.foamOpacity.default,
        foamTransitionRange: s.foamTransitionRange.default,
        foamColor: s.foamColor.default.slice() as [number, number, number],
        foamNoiseStrength: s.foamNoiseStrength.default,
        underwaterEnabled: s.underwaterEnabled.default,
        ...
        mirrorWidth: s.mirrorWidth.default,
        mirrorHeight: s.mirrorHeight.default,
        mirrorPosition: s.mirrorPosition.default.slice() as [number, number, number],
        mirrorRotationY: s.mirrorRotationY.default,
