...
function buildDefaultEnvState(): EnvState {
    ...
    return {
        ...
        iblIntensity: s.iblIntensity.default,
        globalBrightness: s.globalBrightness.default,
        ...
        particleSplashEnabled: s.particleSplashEnabled.default,
        ...
        smallWaveEnabled: s.smallWaveEnabled.default,
        waterAnimSpeed: s.waterAnimSpeed.default,
        planarReflectionBlend: s.planarReflectionBlend.default,
        ...
        waterFogStart: s.waterFogStart.default,
        waterFogEnd: s.waterFogEnd.default,
        ...
        cloudEnabled: s.cloudEnabled.default,
        debugCloudsEnabled: s.debugCloudsEnabled.default,
