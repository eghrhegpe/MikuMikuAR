...
export const ENV_STATE_SCHEMA = {
    ...
    groundStyle:          { type: 'enum',   values: ['solid', 'grid', 'checker', 'texture'] as const, default: 'solid' as const },
    groundDecoStyle:      { type: 'enum',   values: ['none', 'grid', 'checker'] as const, default: 'none' as const },
    ...
    groundPattern:        { type: 'enum',   values: ['checker', 'dots', 'stripes', 'radial'] as const, default: 'checker' as const },
    groundReflectionBlend:   { type: 'number', default: 0.3 },
    groundReflectionQuality:{ type: 'enum', values: ['high', 'medium', 'low', 'off'] as const, default: 'medium' as const },
    ...
    groundProceduralTexture: { type: 'enum', values: ['none', 'wood', 'marble', 'concrete'] as const, default: 'none' as const },
    ...
    particleType:          { type: 'enum', values: ['none', 'sakura', 'rain', 'snow', 'fireworks', 'fireflies', 'leaves'] as const, default: 'none' as const },
    ...
    reflectionQuality:  { type: 'enum', values: ['high', 'medium', 'low', 'off'] as const, default: 'off' as const },
    qualityProfile:     { type: 'enum', values: ['high', 'medium', 'low'] as const, default: 'high' as const },
