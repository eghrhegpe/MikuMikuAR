...
export function registerSettingsActions(): void {
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectResourceRoot(); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('pmx'); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('vmd'); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('audio'); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('prop'); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('stage'); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('environment'); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('md_dress'); },
  });
  ...
  registerAction({
    ...
    params: [],
    destructive: false,
    execute: async () => { await selectOverridePath('setting'); },
  });
  ...
  registerAction({
    ...
    destructive: false,
    execute: async (p) => { setLang(p.code as LangCode); },
  });
}
