...
const _defaultState: PerceptionState = {
    breathFrequency: 0.3, breathAmplitude: 0.02,
    blinkFrequency: 0.25, blinkAmplitude: 1,
    headTrackingEnabled: false, eyeTrackingEnabled: false,
    microExpressionEnabled: false, balanceSwayEnabled: false,
    lipSyncEnabled: false, emotion: 'neutral',
    breathEnabled: true, blinkEnabled: true,
    headGazeMaxYaw: 45, headGazeMaxPitch: 30,
    eyeGazeMaxYaw: 10, eyeGazeMaxPitch: 8, eyeGazeSmooth: 0.7,
    lipSyncSensitivity: 0.5, lipSyncIntensity: 0.5, lipSyncMultiMorphEnabled: false,
    balanceSwayPeriod: 3, balanceSwayAmplitude: 0.3,
};
