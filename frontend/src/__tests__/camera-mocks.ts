...
export const MockCamera = vi.hoisted(() => {
    return class {
        fov = 0.8; position = { x: 0, y: 0, z: 0 }; name = '';
...
export const MockArcRotateCamera = vi.hoisted(() => {
    return class {
        alpha = 0; beta = 0; radius = 0; lowerRadiusLimit = 0; upperRadiusLimit = 0;
        panningSensibility = 50; inertia = 0; angularSensibilityX = 0; angularSensibilityY = 0;
        pinchPrecision = 0; _panningMouseButton = 0; fov = 0.8;
        position = { x: 0, y: 0, z: 0 }; target = { x: 0, y: 8, z: 0 };
        _scene: any; _cameraRotation = { x: 0, y: 0 };
        inputs = { addGamepad: () => {} }; name = '';
        constructor(..._args: any[]) {}
...
export const MockVector3 = vi.hoisted(() => {
    const V3 = class {
        ...
        static One() { return new V3(1, 1, 1); }
    };
    return V3 as any;
});
...
export const MockMmdCamera = vi.hoisted(() => {
    return class {
        ...
        setRuntimeAnimation() {} animate(_frameTime: number) {} dispose() {}
...
export const MockColor4 = vi.hoisted(() => {
    return class {
        ...
        set(r: number, g: number, b: number, a = this.a) { this.r = r; this.g = g; this.b = b; this.a = a; return this; }
        clone() { return new (this.constructor as any)(this.r, this.g, this.b, this.a); }
...
export const MockScene = vi.hoisted(() => {
    return class {
        _uniqueIdCounter = 0; clearColor = { r: 0, g: 0, b: 0, a: 1 }; _engine: any = null;
        lights: any[] = []; meshes: any[] = []; materials: any[] = [];
        ...
        registerBeforeRender() {} unregisterBeforeRender() {} executeWhenReady() {}
        addCamera() {} removeCamera() {} attachControl() {} detachControl() {}
