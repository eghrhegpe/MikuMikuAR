...
vi.mock('babylon-mmd/esm/Runtime/mmdStandardMaterialProxy', () => ({
    MmdStandardMaterialProxy: class {},
}));
...
describe('scene.ts ragdoll wiring', () => {
    ...
    it('should register initRagdoll after startBoneOverride in scene setup flow', () => {
        ...
        expect(
            ragdollIdx,
            'initRagdoll must be registered AFTER startBoneOverride'
        ).toBeGreaterThan(boneIdx);
    });
});
