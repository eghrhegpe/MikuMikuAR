// menu-schema 系列合并（controlspec/dispose/guards/header-toggle/i18n/kinds/statepath 7 文件 → 1）
// [2026-08] 同系列合并以省 isolate 单文件 import 成本（vitest.config 同款先例）。
// 合并范围说明：conflict / motion-module 依赖 vi.resetModules() + vi.doMock 文件级
// 模块图隔离（合并会破坏其「动态 import 重绑 state」前提），modelid 为 node 环境、
// integrity 为独立 mock 集合元测试——以上 4 文件保留独立，仅合并 7 个 happy-dom
// 纯渲染 describe。各 describe 的 container/beforeEach/afterEach 原样保留，互不干扰。
...
// [doc:perf] 语言包改为运行时加载，测试环境直接预填缓存（原 kinds.test.ts 顶层 beforeAll）
beforeAll(() => {
    bundles['zh-CN'] = zhCN;
    bundles['en'] = en;
});
...
// ═══════════════════════════════════════════════════════
// 各 kind 渲染 + modeRow（原 menu-schema.kinds.test.ts）
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════
// visibleWhen 守卫（原 menu-schema.guards.test.ts）
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════
// headerToggle get/set 映射（原 menu-schema.header-toggle.test.ts）
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════
// ControlSpec get/set 衍生控件（原 menu-schema.controlspec.test.ts）
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════
// renderCustom dispose 级联（原 menu-schema.dispose.test.ts）
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════
// i18n 热切换（原 menu-schema.i18n.test.ts）
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════
// StatePath 前缀与 set 链路（原 menu-schema.statepath.test.ts）
// ═══════════════════════════════════════════════════════
