...
> - ⏳ **StreamAudioPlayer 接入** 已立项为 **ADR-107**，见 `docs/adr/adr-107-stream-audio-player.md`。
> - ⏳ **AnimationRetargeter 接入** 已立项为 **ADR-108**，见 `docs/adr/adr-108-animation-retargeter.md`。
> - ⏳ **SdefInjector + SdefMesh 接入** 已立项为 **ADR-109**，见 `docs/adr/adr-109-sdef-injector.md`。
