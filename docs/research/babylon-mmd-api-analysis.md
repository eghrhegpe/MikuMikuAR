...
> - ⏳ 其余（MPR 多线程物理、IMmdModel 类型补全、StreamAudioPlayer、AnimationRetargeter）待立项。

---

# 草案：多线程 WASM 物理实例迁移（MmdWasmInstanceTypeMPR）

> **状态**: 草案 · 待立项（立项时取 docs/adr 最大号+1）
> **日期**: 2026-07-08
> **来源**: 本调研 §2.1 / §五 P0
...
# 草案：向上游补全 IMmdModel 接口以消除类型安全缺口

> **状态**: 草案 · 待立项（部分已落地：`core/types.ts` augmentation + vmd-layers 那处 cast 已由 ADR-098 消除）
> **日期**: 2026-07-08
> **来源**: 本调研 §3.1 / §五 P0
...
> **关联**: BeatDetector / 程序化动作、`outfit/audio.ts` 现状
