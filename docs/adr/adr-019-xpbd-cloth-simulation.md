...
> **日期**: 2026-06-28
> **状态**: 已完成 — xpbd-solver/collider/cloth/renderer + 20 tests 全通过 ⚠️ **已废弃**（XPBD 全栈移除，被 [ADR-081](adr-081-xpbd-removal.md) 取代；源码 xpbd-solver/collider/cloth 等已删；布料功能替代见 ADR-084）
