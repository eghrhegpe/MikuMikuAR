...
> **状态**: 已完成 — 2026-07-06 会话中修复了配置未持久化 Bug（clothConfig 防抖、调试开关、相机/时间流逝状态等），并完成全量覆盖梳理。
> **日期**: 2026-07-06
