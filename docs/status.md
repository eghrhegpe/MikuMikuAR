...
| ADR-178 | 能力矩阵补全宿主级键（四端统一收口） | 实施中（Phase 1 已落地 2026-07-24；Phase 2 分析完成 2026-07-25——virtual-skirt.ts/fileservice.ts 已迁移至能力层，settings-resources.ts:412 待迁移至 watchDir，其余 5 处判定为平台特有逻辑保留不动；Phase 3 待排期） |
