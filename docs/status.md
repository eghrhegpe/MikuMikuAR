...
| Go 端错误 i18n 化（ADR-117） | ✅ 已完成（Phase 1+2 完成） |
...
| 相机行为双轴控制（CameraControl × CameraBehavior，ADR-100，P1-P5 已提交） | ✅ |
...
| ADR-117 | Go 端错误 i18n 化 | ✅ 已完成（Phase 1+2 完成；Phase 3 防回归未启动） |
