...
| ADR-85 | 脚部地面跟随（Feet Adjustment） | Phase A 已完成；Phase B/C 降级搁置（2026-07-19）· 已纳入代码审核 4 项修正（纯文档，无代码变更）· 方案C（WASM 手动 IK）已实施（2026-07-26）· **feet-adjustment 方案A 迁移已完成（2026-07-29，ADR-202 §六）**（2026-07-11） |
