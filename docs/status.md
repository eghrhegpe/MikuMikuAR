...
| IK 感知骨骼覆盖（ADR-122） | ✅ 已完成 |
| 计算覆盖语义规范（ADR-123） | ✅ 已完成 |
| 风格化水体波光粼粼（ADR-115） | ✅ 已完成（P1-P4 全阶段） |
| 脚部地面跟随（ADR-085） | 🔄 部分实现 |
