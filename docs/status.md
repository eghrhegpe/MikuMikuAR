...
| ADR-219 | 测试并发调优与 isolate 污染治理 — vitest 全量提速：maxWorkers 落地 + isolate=false 障碍清理 | 实施中（2026-07-31；Phase 1 已落地省 13%；Phase 2 方案经实测纠偏——「统一 mock 形状」证伪，改走「关键单例模块 mock 全局化」，待 idb spike 验证） |
