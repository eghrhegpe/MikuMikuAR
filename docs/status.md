...
| ADR | 主题 | 状态 |
|-----|------|------|
| ADR-195 | 下载文件夹统一修订（三平台系统下载目录 + 消除"二扫"） | 已立项 · 规划中（设计文档，待代码落地与单测）（2026-07-27（初版）） |
| ADR-194 | 风物理系统修复 — 从「假风」到真实风场 | 已完成（2026-07-27 — tsc 零错误，env-bridge 80 + wind-physics 1 + app.contract 17 全绿）（2026-07-27（初版）） |
