...
| ADR-214 | Menu ID 命名规范治理 | 🔄 实施中（Phase 1 + Phase 2 完成）（2026-07-30） |
| ADR-213 | Go 后端 EnvState 命名漂移修复与契约补全 | 📝 规划（2026-07-30） |
| ADR-212 | 命名 vs 翻译 vs 实际功能错位系统审计与治理 | ✅ 已完成（2026-07-30） |
| ADR-211 | 水面功能开关体系 — 噪声原语消重与效果分组开关化 | 🚧 实施中（2026-07-30） |
