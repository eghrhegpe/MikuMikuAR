...
| ADR | 主题 | 状态 |
|-----|------|------|
| ADR-196 | 内置 AI 诊断助手（LLM Diagnostic Assistant） | 🔄 实施中（Phase 0 骨架 + Batch A(P1) + Batch B(P2) 已落地；待诊断面板 UI 与 Go 侧对接；见 `.trae/specs/adr-196-audit-and-refine/`）（2026-07-28） |
