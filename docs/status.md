...
| ADR-226 | 地面材质单一事实源重构（GroundMaterialSpec） | 规划（2026-08-01） |
...
| ADR-218 | 知识库（docs/knowledge）分层治理 — 痛点与方案 | 已实施（P1~P5 全部落地，2026-08-01 收尾）（2026-07-31） |
...
| ADR-173 | UI 行控件公共化第三轮 + 命名去 `_` 前缀 | 已完成（2026-07-24 执行） |
