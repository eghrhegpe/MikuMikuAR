...
| ADR-132 | 环境亮度统一标量 | 📋 规划 |
| ADR-135 | LibrarySessionStore 资源库状态收敛基座 | 🔄 实施中 | P0.1/P0.3/P1.2/P2 已完成，P1.3 待办 |
...
| ADR-152 | 舞台灯光与体积光散射 | ✅ 已完成（v2 真实光锥） | 真光锥 mesh + ShaderMaterial + 体积散射统一模块 |
...
| ADR-150 | 模型替换与浏览器选中结果统一契约 | ✅ 已完成 | BrowseOutcome.activateItem 统一契约 |
| ADR-151 | 反射系统统一架构 | ✅ 已完成 | render-passes 模式 + 实时/烘焙双模 |
| ADR-152 | 舞台灯光与体积光散射 | ✅ 已完成（v2 真实光锥） | 真光锥 + 体积散射统一模块 |
| ADR-153 | 无障碍支持总体方案 | 🔄 规划中 | Phase 2/3 规划中 |
