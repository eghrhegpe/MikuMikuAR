...
- [x] 前端 Vitest 测试套件（4 文件 93 tests，全量覆盖真 import 而非本地 mock）:
...
|------|--------|------|
| 单独材质编辑器 | P1 | 材质系统扩展 |
| VPD 姿势导入 | P3 | VMD 加载器扩展 |
| 模型加载预设 | P3 | 配置系统 |
| 软件管理 | P3 | 扫描系统扩展 |
| 程序化动作（Idle Motion/Auto Dance） | P3 | WASM 动画扩展 |
| 换装系统 / 纹理增强 | P4 | 模型系统扩展 |
...
**测试基建已就绪**
- Vitest 前端测试套件 93 tests，4 文件全量真 import
