...
| `CameraState()` | `scene/scene:866` | — |
| `DEFAULT_MAT_PARAMS()` | `scene/scene:147` | — |
| `EnvState()` | `scene/scene:829` | — |
| `LightState()` | `scene/scene:868` | — |
| `LoadLastScene()` | `scene/scene:867` | — |
| `MaterialCategory()` | `scene/scene:171` | — |
| `MaterialCategoryParams()` | `scene/scene:171` | — |
| `ModelInstance()` | `scene/scene:829` | — |
| `RenderState()` | `scene/scene:869` | — |
| `SaveLastScene()` | `scene/scene:867` | — |
| `SaveThumbnail()` | `scene/scene:867` | — |
| `SetEnvState()` | `scene/scene:867` | — |
| `StageLightState()` | `scene/scene:868` | — |
| `__envDebug()` | `scene/scene:335` | — |
| `_applyAll()` | `scene/scene:147` | — |
| `_catState()` | `scene/scene:147` | — |
| `_matEnabled()` | `scene/scene:147` | — |
| `_matState()` | `scene/scene:147` | — |
| `animateCameraVmd()` | `scene/scene:852` | — |
| `applyEnvState()` | `scene/scene:839` | — |
...
| `autoFrame()` | `scene/scene:852` | — |
| `autoLoop()` | `scene/scene:810` | — |
| `canUndo()` | `scene/scene:831` | — |
| `captureThumbnail()` | `scene/scene:851` | — |
| `clearCameraVmd()` | `scene/scene:852` | — |
| `disposeModelSssState()` | `scene/scene:173` | — |
| `disposeScene()` | `scene/scene:278` | 级联释放 Scene → Engine 及其所有子资源。 |
| `dom()` | `scene/scene:810` | — |
| `engine()` | `scene/scene:234` | — |
| `envState()` | `scene/scene:810` | — |
| `focusedMmdModel()` | `scene/scene:353` | — |
| `focusedModel()` | `scene/scene:353` | — |
| `focusedModelId()` | `scene/scene:810` | — |
| `formatTime()` | `scene/scene:810` | — |
| `getCameraMode()` | `scene/scene:852` | — |
| `getCameraState()` | `scene/scene:852` | — |
| `getCameraVmdName()` | `scene/scene:852` | — |
| `getCameraVmdPath()` | `scene/scene:852` | — |
...
| `getScene()` | `scene/scene:796` | — |
| `hasCameraVmd()` | `scene/scene:852` | — |
| `initCameraSystem()` | `scene/scene:852` | — |
| `initLoader()` | `scene/scene:851` | — |
| `initPlaybackObservables()` | `scene/scene:809` | — |
| `initScene()` | `scene/scene:382` | 场景初始化入口。首次调用时创建 Scene/Engine/运行时； HMR 重入时先调用 _reinitSceneForHMR() 清理旧资源再重建。 |
...
| `isPlaying()` | `scene/scene:810` | — |
| `loadCameraVmd()` | `scene/scene:852` | — |
| `loadCameraVmdFromPath()` | `scene/scene:803` | — |
| `loadPMXFile()` | `scene/scene:851` | — |
| `loadVMDFromPath()` | `scene/scene:803` | — |
| `loadVMDMotion()` | `scene/scene:803` | — |
| `loadVPDPose()` | `scene/scene:803` | — |
| `mmdRuntime()` | `scene/scene:810` | — |
| `modelManager()` | `scene/scene:326` | — |
| `modelRegistry()` | `scene/scene:810` | — |
| `normPath()` | `scene/scene:830` | — |
| `offerSceneUndo()` | `scene/scene:831` | — |
| `offerSceneUndoAndRefresh()` | `scene/scene:831` | — |
| `popUndoSnapshot()` | `scene/scene:831` | — |
| `pushUndoSnapshot()` | `scene/scene:831` | — |
| `resetMatCatParams()` | `scene/scene:147` | — |
| `resetPerMaterialParams()` | `scene/scene:147` | — |
| `resetSingleMatParams()` | `scene/scene:147` | — |
| `resolveFileUrl()` | `scene/scene:830` | — |
| `restoreUndoSnapshot()` | `scene/scene:831` | — |
| `scene()` | `scene/scene:245` | — |
| `seekDragging()` | `scene/scene:810` | — |
| `seekFromEvent()` | `scene/scene:809` | — |
| `setAutoLoop()` | `scene/scene:810` | — |
| `setCameraState()` | `scene/scene:852` | — |
| `setFocusedModelId()` | `scene/scene:810` | — |
| `setIsPlaying()` | `scene/scene:810` | — |
...
| `setMmdRuntime()` | `scene/scene:810` | — |
| `setModelRegistry()` | `scene/scene:810` | — |
| `setSeekDragging()` | `scene/scene:810` | — |
| `setStatus()` | `scene/scene:810` | — |
| `setTriggerAutoSave()` | `scene/scene:828` | — |
| `switchCameraMode()` | `scene/scene:852` | — |
| `triggerAutoSave()` | `scene/scene:828` | — |
| `updatePlaybackUI()` | `scene/scene:809` | — |
