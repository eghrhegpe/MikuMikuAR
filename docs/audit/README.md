...
| 2026-08-15 | 第 37 轮：轨道控制/主相机/菜单 schema | `core/orbit`, `scene/camera`(主模块), `menus/menu-schema`(渲染层) | 3 模块：3✅（P1×0 / P2×0 / P3×10 登记：AR 竞态 cleanup 路径测试无法区分、getBindFn 丢弃 modelId、钳制逻辑复制等；round-13 camera 三项问题全部确认修复） | [orbit](2026-08-15-round37-orbit.md) · [camera](2026-08-15-round37-camera.md) · [menu-schema](2026-08-15-round37-menu-schema.md) |
| 2026-08-15 | 第 38 轮：姿态三件套/动画重定向/Go 错误 | `scene/pose`(camera-angle/构图/水印), `scene/motion/animation-retargeter`, `core/i18n/goerr` | 3 模块：3✅（P1×0 / P2×0 / P3×10 登记：重定向并发加载无代际守卫、custom 映射无法序列化、goerr 信封缺 code 噪音等；pose 覆盖率 4.4%→99.18%；round-11 重定向泄漏已修复确认） | [pose](2026-08-15-round38-pose.md) · [animation-retargeter](2026-08-15-round38-animation-retargeter.md) · [goerr](2026-08-15-round38-goerr.md) |
| 2026-08-15 | 第 39 轮：场景核心/模型管理器/相机状态 | `scene/scene`, `scene/manager/model-manager`, `scene/camera/camera-state` | 3 模块：2✅ / 1⚠️（P1×0 / P2×1 登记：scene 测试按参数位置索引取回调易错位；P3×9 登记：model-manager updateFn 零覆盖、focus 同步异常逃逸、dispose 不清 per-model 状态等；ADR-251 循环依赖仍遗留） | [scene](2026-08-15-round39-scene.md) · [model-manager](2026-08-15-round39-model-manager.md) · [camera-state](2026-08-15-round39-camera-state.md) |
| 2026-08-15 | 第 40 轮：环境天空/模型预设/适配器契约 | `scene/env/env-sky`, `menus/model-preset`, `core/mmd-adapter`(契约层) | 3 模块：1✅ / 2⚠️（P1×0 / P2×2 登记：env-sky 覆盖仅 10%、依赖环未登记；P3×8 修复 2：model-preset 可选链防裸 TypeError、material setMatParams NaN matIndex 幽灵 entry 守卫；P4×10 登记） | [env-sky](2026-08-15-round40-env-sky.md) · [model-preset](2026-08-15-round40-model-preset.md) · [mmd-adapter-contract](2026-08-15-round40-mmd-adapter-contract.md) |
| 2026-08-15 | 第 41 轮：VMD 过滤/模型注册表/感知 morph | `scene/motion/vmd-layers`(_filterVmdBones), `scene/manager/model-manager`(注册表), `scene/motion/perception`(微表情+唇形) | 3 模块：1✅ / 2⚠️（P1×0 / P2×2 登记：perception 注销路径不清零 morph influence——切走模型后表情权重冻结（需跨模块修复区分感知层/用户 morph）；scene-model 自证测试（round-39 已真实覆盖）；P3×12 登记） | [vmd-layers-filter](2026-08-15-round41-vmd-layers-filter.md) · [scene-model](2026-08-15-round41-scene-model.md) · [perception-morph](2026-08-15-round41-perception-morph.md) |
| 2026-08-15 | 第 42 轮：舞台灯/感知状态/视线追踪 | `scene/render/lighting-stage`, `scene/motion/perception`(状态生命周期), `scene/motion/perception-gaze` | 3 模块：3✅（P1×0 / P2×0 / P3×8 登记：MAX_STAGE_LIGHTS 跨文件耦合、migratePerceptionData 缺 pinned 结构校验、setPerceptionState 批量钳制不全、gaze 死常量值不一致等） | [lighting-stage](2026-08-15-round42-lighting-stage.md) · [perception-state](2026-08-15-round42-perception-state.md) · [gaze](2026-08-15-round42-gaze.md) |
| 2026-08-15 | 第 43 轮：物理契约核心/约束/感知多模型 | 真实 WASM Bullet 契约层, `scene/motion/perception`(骨骼认领/多模型) | 3 模块：1✅ / 2⚠️（P1×0 / P2×3 登记：弹簧行为验证名实不符(锁定行程未释放)、claim 侧不失效 bake 门控——运行时优先级语义反转、冲突 banner 恒显内部子模块冲突；P3×10 登记） | [physics-contract-core](2026-08-15-round43-physics-contract-core.md) · [physics-contract-constraint](2026-08-15-round43-physics-contract-constraint.md) · [perception-multi-model](2026-08-15-round43-perception-multi-model.md) |
| 2026-08-15 | 第 44 轮：物理碰撞/刚体契约/呼吸 | 真实 WASM Bullet 契约层(碰撞世界+刚体), `scene/motion/perception-breathing` | 3 模块：2✅ / 1⚠️（P1×0 / P2×1 修复：round-15 P1-2 遗留 linkedBone 未判空→可选链守卫；P3×7 登记：碰撞过滤字段零行为验证、helper 字段重复内联等） | [physics-contract-collision-worlds](2026-08-15-round44-physics-contract-collision-worlds.md) · [physics-contract-rigidbody](2026-08-15-round44-physics-contract-rigidbody.md) · [perception-breathing](2026-08-15-round44-perception-breathing.md) |
| 2026-08-15 | 第 45 轮：模型 ID/管线契约/材质回合 | `scene/manager/model-id`, `scene/motion/motion-pipeline`(stage 契约), `scene/manager/material`(getMatState 回合) | 3 模块：2✅ / 1⚠️（P1×0 / P2×1 修复：setMatEnabled NaN matIndex 守卫(round-40 同类缺口对齐)；P3×3 登记：非 uuid 字符串透传、真实 stage 声明无断言等） | [resolve-model-id](2026-08-15-round45-resolve-model-id.md) · [proc-bone-override](2026-08-15-round45-proc-bone-override.md) · [stable-identity-material](2026-08-15-round45-stable-identity-material.md) |
| 2026-08-15 | 第 46 轮：动作数学/PBR 初始化/菜单动作 schema | `scene/motion/motion-modules/motion-math`, `scene/manager/pbr-builder-init`, `menu-schema`(motionModule 前缀) | 3 模块：2✅ / 1⚠️（P1×0 / P2×2 修复：scene-pbr-init 补回退路径测试、motion-math JSDoc 标注 computeSwayYaw 未接线；P3×7 登记） | [motion-math](2026-08-15-round46-motion-math.md) · [scene-pbr-init](2026-08-15-round46-scene-pbr-init.md) · [menu-schema-motion-module](2026-08-15-round46-menu-schema-motion-module.md) |
| 2026-08-15 | 第 47 轮：帧钩子回归/性能反射/平面反射 | `motion-modules`(帧钩子), `performance-env-bridge`, `planar-reflection`(统一引擎) | 3 模块：1✅ / 2⚠️（P1×0 / P2×0 / P3×10 登记：互斥守卫阻断行为无测试锁定(C1 类回归缺口)、mirrorTexture 分支缺口、inferQualityProfile 零消费者等；round-12 P1 修复验证成立、C1 死代码 ADR-092 根除确认） | [side-hooks](2026-08-15-round47-side-hooks.md) · [performance-reflection](2026-08-15-round47-performance-reflection.md) · [planar-reflection](2026-08-15-round47-planar-reflection.md) |
| 2026-08-15 | 第 48 轮：环境反射/VMD 求值器/动作桥 | `scene/env/env-reflection`, `motion-algos/vmd-evaluator`+`vmd-writer`, `core/scene-action-bridge` | 3 模块：2✅ / 1⚠️（**P1×1 修复：vmd-writer 插值字节序 [x1,y1,x2,y2]→[x1,x2,y1,y2]——babylon-mmd loader 按 x1,x2,y1,y2 读取，旧序致全部缓动预设退化线性**；P2×2 登记：NullEngine 不 dispose、createVmdEvaluator 无 try/catch；P3×4 登记） | [env-reflection](2026-08-15-round48-env-reflection.md) · [vmd-evaluator](2026-08-15-round48-vmd-evaluator.md) · [scene-action-bridge](2026-08-15-round48-scene-action-bridge.md) |
| 2026-08-15 | 第 49 轮：schema 完整性/默认动作替换/modelId 覆盖 | `menu-schema-register`(元测试), `scene/motion/motion-intent`(replaceDefault), `menu-schema`(modelId 覆写) | 3 模块：1✅ / 2⚠️（P1×0 / P2×2 登记：RENDER_KEYS 真相源被 mock 偷换致 bind 校验盲区、UI_KEYS 硬编码表漂移(缺 10 字段含 2 幽灵)；P3×8 登记：motionModule modelId 覆写通路零覆盖(round-46 缺口延续)等） | [menu-schema-integrity](2026-08-15-round49-menu-schema-integrity.md) · [motion-intent-replace-default](2026-08-15-round49-motion-intent-replace-default.md) · [menu-schema-modelid](2026-08-15-round49-menu-schema-modelid.md) |
| 2026-08-15 | 第 50 轮：riding 接线/冲突标记/注册表快照 | `motion-modules`(riding 时序), `menu-schema`(conflictHint), `motion-modules-registry`(快照) | 3 模块：2✅ / 1⚠️（P1×0 / P2×0 / P3×10：**修 conflictHint i18n key 五语言缺失(hover 显示原始 key 乱码)**；滑块冲突与 round-43 banner 同根因联动登记等） | [motion-modules-timed](2026-08-15-round50-motion-modules-timed.md) · [menu-schema-conflict](2026-08-15-round50-menu-schema-conflict.md) · [registry-snapshot](2026-08-15-round50-registry-snapshot.md) |
| 2026-08-15 | 第 51 轮：配置格式/异步工具/视线双路径 | `core/format`+`library-state`, `core/async`, `scene/motion/perception-gaze` | 3 模块：2✅ / 1⚠️（P1×0 / P2×0 / P3×7 登记：async 与 lifecycle 测试重复覆盖、gaze 幽灵 mock(路径不存在致 AR 分支零覆盖)、gaze 循环依赖等；round-24 clear* 遗留确认） | [config](2026-08-15-round51-config.md) · [utils-async](2026-08-15-round51-utils-async.md) · [perception-gaze](2026-08-15-round51-perception-gaze.md) |
| 2026-08-15 | 第 52 轮：管线排序/个人灯/唇形桥 | `scene/motion/motion-pipeline`, `scene/render/lighting-follow`, `scene/motion/lipsync-bridge` | 3 模块：3✅（P1×0 / P2×0 / P3×6 登记：管线并列键稳定排序未锁、个人灯腰骨匹配三处重复、lipsync-bridge 注册副作用零断言等；fix P2 相机同步核实正确） | [motion-pipeline](2026-08-15-round52-motion-pipeline.md) · [lighting-follow](2026-08-15-round52-lighting-follow.md) · [lipsync-bridge](2026-08-15-round52-lipsync-bridge.md) |
| 2026-08-15 | 第 53 轮：环境持久化/middleware/cel 地面 | `env-persist`(防抖), `env-bridge`(setEnvState middleware), `env-bridge`(cel 地面耦合) | 3 模块：3⚠️（P1×0 / P2×7 登记：中间件时序耦合致自动降级误判/ground 预设脱离不可还原、env-persist 并发双写竞态无守卫、cel 测试无判别力+visibilitychange hidden 残余落盘窗口；P3×11 登记） | [env-persist](2026-08-15-round53-env-persist.md) · [middleware](2026-08-15-round53-middleware.md) · [cel-ground-persist](2026-08-15-round53-cel-ground-persist.md) |
| 2026-08-15 | 第 54 轮：env facade/预设/重力太阳 | `env-bridge`(_applyEnvStateFacade), `env-time-of-day`(applyEnvPreset), `env-bridge`(gravity/sun) | 3 模块：2✅ / 1⚠️（P1×0 / P2×1 登记：facade 断言固化 mock 隔离语义与生产相悖；**修 syncEnvSunAngle 与 preset.sunAngle 钳制 [-15,90]——round-12/53/54 反复登记 P3 收敛**；P3×12 登记） | [facade](2026-08-15-round54-facade.md) · [presets](2026-08-15-round54-presets.md) · [gravity-sun](2026-08-15-round54-gravity-sun.md) |
| 2026-08-15 | 第 55 轮：setEnvState 入口/时间系统/功能级别 | `env-bridge`(setEnvState 中央入口), `env-time-of-day`(Time of Day), `menus/env-*-levels`(契约) | 3 模块：2✅ / 1⚠️（P1×0 / P2×1 登记：migrateEnvState 白名单+12 迁移器零测试(round-18 Object.hasOwn 修复无护栏)；P3×10 登记：time-of-day else-if 分支无唯一覆盖、feature-levels 三处死 mock 等；round-54 钳制修复确认收敛） | [set-env-state](2026-08-15-round55-set-env-state.md) · [time-of-day](2026-08-15-round55-time-of-day.md) · [env-feature-levels](2026-08-15-round55-env-feature-levels.md) |
