 ...
 *   - adr-258「📊 参考文档（非决策）」→ 已归档（参考文档=非决策归档材料，归入归档语义族）
 *
...
const _RE_ARCHIVE = /^(?:已废弃|已过时|已放弃|已搁置|已退役|废弃|放弃|搁置|归档|落档|作废|取消|被取代|已被|superseded)|(?:⚠️|🗑️|📋)\s*\*{0,2}(?:已废弃|已过时|已放弃|已搁置|已退役|被取代|已被)|(?:调研归档|调研落档|归档登记)|参考文档|证伪/i;
